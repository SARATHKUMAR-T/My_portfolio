...
function Skills() {
  return (
    <section
      ...
      id="skills"
    >
      <h1 className="uppercase text-center mt-2 sm:mt-6 text-4xl sm:text-6xl lg:text-6xl font-bold tracking-wider">
        <span className="text-lime-300">S</span>kills
      </h1>
      <div className=" rounded-lg gap-8 text-slate-100 flex items-center justify-center  flex-col max-w-4xl mx-auto mt-2 sm:mt-6 px-4 py-4 sm:py-12">
