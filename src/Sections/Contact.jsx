...
function Contact() {
  ...
  return (
    ...
    >
      ...
      <div className="flex mt-8 bg-slate-200 rounded-lg max-w-md md:max-w-xl mx-auto px-4 py-6 text-white items-center justify-center">
        <form
        ...
        >
          <div className="relative z-0 w-full mb-6 group">
            <input
              ...
              className="block py-2.5 px-2 rounded-lg w-full text-sm text-gray-800 bg-transparent border-0 border-b-2 border-gray-300 appearance-none   focus:outline-none focus:ring-0 focus:border-blue-600 peer"
              placeholder=" "
              {...register("name")}
              required
            />
