...
import zemo from "../assets/zemo.png";
...
function Projects() {
  return (
    ...
    >
      ...
      <div className="uppercase text-center text-4xl sm:text-6xl lg:text-8xl font-bold tracking-wider max-w-7xl  mx-auto mt-12 grid grid-cols-1 lg:grid-cols-[auto,1fr,1fr] ">
        ...
        <div className="py-0 lg:py-12 ">
          <div className="text-xs py-2 sm:py-8 text-slate-800  px-2  space-y-1 sm:space-y-5 relative  w-[70%] shadow-2xl shadow-blue-700 rounded-md  xl:rounded-tl-[20%] xl:rounded-br-[20%]  mx-auto lg:mr-auto bg-gray-100 mt-12 lg:mt-24">
            <p className=" pt-5 ">GloBill</p>
            <p className="text-center text-md  px-6 tracking-wider text-cyan-500">
        ...
        <div className="py-0 lg:py-12 ">
          <div className="text-xs text-slate-800  space-y-1 sm:space-y-5 relative  w-[70%] shadow-2xl shadow-blue-700 rounded-md  xl:rounded-tl-[20%] xl:rounded-br-[20%]  mx-auto lg:mr-auto bg-gray-100 mt-12 lg:mt-24">
            <p className=" pt-5  ">zemo</p>
            <p className="text-center text-md  px-6 tracking-wider text-cyan-500">
              Streak App
            </p>
            <p className="capitalize w-3/4 tracking-wider text-xs sm:text-sm leading-6 mx-auto">
              Zemo is a revolutionary self-development app designed to empower
              you on your journey of personal growth.With Zemo, you can easily
              create and track your self-improvement streaks.
            </p>
            <div>
              <p className="text-slate-900 underline decoration-2 decoration-slate-800 tracking-widest">
                Tech Stacks Used
              ...
              <div className="grid grid-cols-2 grid-rows-2 xl:grid-cols-2 lg:grid-rows-1  tracking-wider  w-3/4  gap-2 lg:gap-4  mx-auto mt-2">
                ...
                <p className="bg-blue-700 text-slate-100 px-2 py-1 rounded-md">
                  Nextjs
                </p>
                <p className="bg-green-700 text-slate-200 px-1 py-1 rounded-md ">
                  Mongodb
            ...
            <div>
              ...
              <div className="grid grid-cols-1 grid-rows-3 md:grid-cols-2 md:grid-rows-2 ">
                <div className="flex hover:scale-105 duration-300 text-cyan-500 w-full justify-center mx-auto items-center gap-2 my-3">
                  <a
                    href="https://github.com/SARATHKUMAR-T/zemo"
                    target="_blank"
                    rel="noreferrer"
                    className=" inline-block"
                  >
                ...
                <div className="flex hover:scale-105 duration-300 text-cyan-500  justify-center mx-auto items-center gap-2 my-3">
                  <a
                    href="https://github.com/SARATHKUMAR-T/zemo_backend"
                    target="_blank"
                    rel="noreferrer"
                    className=" inline-block"
                  >
        ...
        {/* 2nd project project details */}
        <div className="py-0 lg:py-12 ">
          <div className="text-xs  py-2 sm:py-8 text-slate-800  space-y-1 sm:space-y-5 relative  w-[70%] shadow-2xl shadow-blue-700 rounded-md  xl:rounded-tl-[20%] xl:rounded-br-[20%]  mx-auto lg:mr-auto bg-gray-100 mt-12 lg:mt-24">
            ...
            <p className="capitalize w-3/4 tracking-wider text-xs sm:text-sm leading-6 mx-auto">
              ...
              book blogging and discussions.
              <br />
              Users Can create and read blogs about book.{" "}
            </p>
            <div>
              <p className="text-slate-900 underline decoration-2 decoration-slate-800 tracking-widest">
                Tech Stacks Used
        ...
        {/* 2nd project project details */}
        <div className="py-0 lg:py-12 ">
          <div className="text-xs py-2 sm:py-8 text-slate-900 shadow-2xl shadow-blue-700 rounded-md xl:rounded-tl-[20%] xl:rounded-br-[20%]  space-y-1 sm:space-y-5 relative  w-[70%]   mx-auto lg:mr-auto bg-gray-100 mt-12 lg:mt-24">
            ...
            <div>
              ...
              <div className="grid grid-cols-1 grid-rows-3 md:grid-cols-2 md:grid-rows-2 ">
                ...
                <div className="flex hover:scale-105 duration-300 text-cyan-500  justify-center mx-auto items-center gap-2 my-3">
                  <a
                    href="https://github.com/SARATHKUMAR-T/pizzaria-backend"
                    target="_blank"
                    rel="noreferrer"
                    className=" inline-block"
                  >
        ...
        <div className="text-8xl tracking-widest  px-4 pt-3">
          <motion.p
            ...
            transition={{ duration: 0.8 }}
          >
            0<span className="text-slate-100">5</span>
          </motion.p>
        </div>
